...
object StreamingKMeans {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // And as test data us received, we'll keep refining our clustering model and printing out the
    // results. In the real world, we'd just use predictOn( which only experts feature data, as you
